...
include("processor/app_class.php")
$obj = new login();
?>
...
<body>
    ...
    <main class="main">
        ...
        <nav class="navbar">
            ...
            <div class="navbar-wrapper">
                ...
                <div class="navbar_right">
                    ...
                    <a class="btn login-btn" href="login.html">Log in</a>
                    <a class="btn signup-btn" href="register.html">Sign up</a>
                </div>
            </div>
        ...
        <div class="main-contents">
            ...
            <a href="booking.html" class="btn book-btn">Book Your Seat</a>
        </div>
    </main>
    <!-- Guidline section -->
        ...
        <div class="guideline_wrapper">
            ...
            <div class="guideline-boxes-wrapper">
                ...
                <div class="guideline-box guideline-2">
                    ...
                    <p>
                        Select your seat number from 1 to 50
                    </p>
                </div>
    ...
    <section class="why-us-section" id="service">
        <div class="why-us-wrapper">
            <div class="col-1">
                ...
                <a href="booking.html" class="btn book-btn-sm">Book Your Ticket</a>
            </div>
            <div class="col-2"></div>
        </div>
    </section>
